BLOCKS[212] = {
    name: 'Список страниц(3 колонки)',
    settings: [
        ['html_variant', 'Список страниц(3 колонки)'],
    ],
    id_categories:[
    ...
    tags:[
        ...
        },
        {
            ...
            tags_options: [
                ...
                [EnumOption.PADDING, {val:[0, 15,30,15],edit_option: EnumEditOption.NONEDITABLE}],
        ...
        },
        {
            ...
            tags_options: [
                ...
                [EnumOption.PADDING, {val:[15,0,0,0]}],
...

        {
            ...
            tags_options: [
                ...
                [EnumOption.WIDTH, {val:100, unit: '%',edit_option: EnumEditOption.NONEDITABLE}],
                [EnumOption.DISPLAY, {val:'flex',edit_option: EnumEditOption.NONEDITABLE}],
                [EnumOption.HEIGHT, {val:233,edit_option: EnumEditOption.NONEDITABLE}],
