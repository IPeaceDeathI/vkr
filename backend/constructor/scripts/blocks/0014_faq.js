BLOCKS[14] = {
    // Прикрутить скрипт разворачивания пунктов
    name: 'Вопросы и ответы',
    id_categories: [
        EnumCategories.SERVICES,
    ],
    settings:[
        ['html_variant', 'Вопросы и ответы'],
    ],
    html_variants:[
        [
            'Вопросы и ответы',
    ...
    tags:[
        {
            ...
            title: 'Главный блок',
            tags_options: [
                [EnumOption.DISPLAY, {val:'flex',edit_option:EnumEditOption.ADVANCED}],
                [EnumOption.JUSTIFY_CONTENT, {val:'center',edit_option:EnumEditOption.ADVANCED}],
        ...
        },
        {
            ...
            tags_options: [
                ...
                // [EnumOption.ATTIBUTE, {key:'event-time',val:['110']}],
            ],
            tags_options_mobile: [
