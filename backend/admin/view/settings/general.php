<div class="admin-content">
      <header class="container narrow">
        <div data-is="admin-breadcrumbs" class="admin-breadcrumbs text-title animate"> <a class="style-link-ignore breadcrumb first   active" href="/admin/settings/general"> Общие </a> </div>
      </header>
      <section class="container  narrow">

        
        <div data-is="proxy" is="settings-section-general" style="" class="settings-section-general pb60 ">
          <div class="group-list slide-down-animation">


            <div is="proxy" data-is="settings-block-favicon" class="settings-block-favicon group-content">
              <div class="flexbe-title text-subtitle inline-box"> <span class="flexbe-text">Иконка favicon</span> </div>
              <div class="flexbe-white-box shadow inline-box drop-zone-target">
                <div class="flexbe-button filled small is-secondary mr10 favicon-preview"> <img class="flexbe-icon size-16" src="/files/favicon_20221011170443.png">
                  <div class="delete-favicon"></div>
                </div>  
                <div data-is="flexbe-button-upload" regular-class="is-secondary" common-class="small filled" file-type="image" accept="image/png,image/svg+xml" drop-zone=".drop-zone-target" url="/admin/api/project/560722/settings/favicon/upload/" class="flexbe-button-upload   upload-favicon size-small">
                  <label class="file-select flexbe-button status-default small filled is-secondary">
                    <input type="file" class="file-input" ref="fileInput" name="file" title="" accept="image/png,image/svg+xml">
                    <div class="upload-text show"> <span class="flexbe-text">Загрузить</span> </div>
                  </label>  
                </div>  
                <div class="size-helper flexbe-desc">
                  <svg class="flexbe-icon size-16">
                    <use xlink:href="/<?=VERSION?>/admin/resources/images/editor_media.svg?1#recomend_size"></use>
                  </svg> <span class="flexbe-text">Размер иконки: 192×192 px | Формат: PNG, SVG</span> </div>  
              </div>    
            </div>  
            ...
            <div class="collection-item block">
              ...
              <div class="media-select">
                <div class="media-select__item ">
                  ...
                  <div class="media-select__text-wrap">
                    <svg class="flexbe-icon size-16 media-select__svg">
                      <use xlink:href="/<?=VERSION?>/admin/resources/images/settings.svg?1c7acb5f1#icon-check"></use>
                    </svg> <span class="flexbe-text text-note font-ui media-select__text">Без эффекта</span> </div>
                </div>
                <div class="media-select__item ">
                  <div class="media-select__preview "> <img class="poster" src="/<?=VERSION?>/admin/resources/images/fade_in.png"> </div>
                  <div class="media-select__text-wrap">
                    <svg class="flexbe-icon size-16 media-select__svg">
                      <use xlink:href="/<?=VERSION?>/admin/resources/images/settings.svg?1c7acb5f1#icon-check"></use>
                ...
                <div class="media-select__item check">
                  <div class="media-select__preview "> <img class="poster" src="/<?=VERSION?>/admin/resources/images/slide_up.png"> </div>
                  <div class="media-select__text-wrap">
                    <svg class="flexbe-icon size-16 media-select__svg">
                      <use xlink:href="/<?=VERSION?>/admin/resources/images/settings.svg?1c7acb5f1#icon-check"></use>
        ...
        <div class="flexbe-white-box shadow inline-box"> <img class="adaptive-preview" src="/<?=VERSION?>/admin/resources/images/adaptive.png" alt="">
  ...
  <div is="settings-block-draft" class="settings-block-draft group-content ">
    <div class="inline-box between">
      <div class="flexbe-title text-subtitle inline-box"><span class="flexbe-text">Статус сайта</span></div>
      <div is="proxy" data-is="admin-save-text" class="admin-save-text flexbe-desc">
    ...
    <div class="status-crads-list inline-box">
      <div class="flexbe-white-box shadow active"><img class="lock-preview" src="/<?=VERSION?>/admin/resources/images/public-project.png" alt="">
        <div class="flexbe-title mt20">Сайт опубликован</div>
        <div class="flexbe-desc text-center">Доступен для посетителей, учитывается в лимите сайтов</div>
        <svg is="flexbe-icon" icon="icon-check" sprite="/<?=VERSION?>/admin/resources/images/settings.svg?1c7acb5f1" size="18" class="flexbe-icon size-18 ">
          <use href="/_s/images/admin/settings.svg?1c7acb5f1#icon-check"></use>
        </svg>
      </div>
      <div class="flexbe-white-box shadow "><img class="lock-preview" src="/<?=VERSION?>/admin/resources/images/draft-project.png" alt="">
        <div class="flexbe-title mt20">Сайт-черновик</div>
        <div class="flexbe-desc text-center">Закрыт паролем, не учитывается в лимите сайтов</div>
        <svg is="flexbe-icon" icon="icon-check" sprite="/_s/images/admin/settings.svg?1c7acb5f1" size="18" class="flexbe-icon size-18 ">
          <use href="/_s/images/admin/settings.svg?1c7acb5f1#icon-check"></use>
        </svg>
      </div>
    </div>
  ...
  <div is="settings-block-access" class="settings-block-access group-content">
    <div class="flexbe-title text-subtitle inline-box"><span class="flexbe-text">Доступ к сайту</span></div>
    <div class="flexbe-white-box shadow inline-box between">
      <div class="settings-block-access__code inline-box">
        <div class="flexbe-text text-xl text-medium">622505</div>
        <div is="proxy" data-is="flexbe-button-copy" class="flexbe-button-copy flexbe-button style-text tooltipstered" state="copy">
          <svg class="flexbe-icon size-16">
            <use xlink:href="/<?=VERSION?>/admin/resources/images/core.svg?1c7acb5f#copy"></use>
          </svg>
        </div>
      </div>
      <div class="flexbe-desc">Черновики и сайты с техническими адресами закрыты для публичного просмотра</div>
    </div>
  </div>
