...
/**
 * @param \Noks\Model\Stat\Integration\Source\Webhook\StatSourceWebhookLeadModel
 */
final class StatSourceWebhookLead extends NoksMigration
{
    public string $name = 'stat_source_webhook_lead';
