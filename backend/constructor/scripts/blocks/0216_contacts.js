BLOCKS[216] = {
    ...
    settings: [
        ['html_variant', 'Контакты с картой'],
    ],
    id_categories:[
    ...
    tags:[
        ...
        },
        {
            ...
            tags_options: [
                ...
                [EnumOption.WIDTH, {val:40,unit: '%',edit_option: EnumEditOption.NONEDITABLE}],
        ...
        },
        {
            ...
            tags_options: [
                [EnumOption.DISPLAY, {val:'flex',edit_option: EnumEditOption.NONEDITABLE}],
                [EnumOption.FLEX_WRAP, {val:'wrap',edit_option: EnumEditOption.NONEDITABLE}],
                [EnumOption.WIDTH, {val:60,unit: '%',edit_option: EnumEditOption.NONEDITABLE}],
                [EnumOption.PADDING, {val:[0, 15, 0, 15],edit_option: EnumEditOption.NONEDITABLE}],
            ],
            tags_options_tablet: [
        ...
        {
            class: 'iframe',
            title: 'Карта( Вставьете src из iframe yandex map)',
            tags_options: [
                [EnumOption.WIDTH_PERCENT, {val:100}],
                [EnumOption.HEIGHT, {val:500}],
                [EnumOption.ATTR, {name:'src', val:'https://yandex.ru/map-widget/v1/?um=constructor%3A68309725a0eea620f28b10877298efe194a140314a70a88f887560e6df4c1b4c&amp;source=constructor'}],
            ],
            tags_options_mobile: [
            ...
            <div class="services">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="column-2">
                            <div class="map-wrapper" contenteditable>
                            <iframe src="" frameborder="0" contenteditable></iframe>
