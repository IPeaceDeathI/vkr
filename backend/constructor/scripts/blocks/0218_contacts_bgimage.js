BLOCKS[218] = {
    name: "Контакты фон-картинка",
    settings: [["html_variant", "Контакты фон-картинка"]],
    id_categories: [EnumCategories.CONTACTS],
    tags: [
        {
            tag: "",
            class: ".section",
            ...
            tags_options: [
                [
                    ...
                    { val: "/resource/img/constructor_default/214/bg.jpg" },
                ],
        ...
        },
        {
            ...
            tags_options: [
                ...
                [
                    ...
                    { val: "none", edit_option: EnumEditOption.NONEDITABLE },
                ],
                [
                    EnumOption.PADDING,
                    {
            ...
            tags_options_tablet: [[EnumOption.FONT_SIZE, { val: 18 }]],
            tags_options_mobile: [[EnumOption.FONT_SIZE, { val: 16 }]],
        },
        {
            tag: "",
            class: ".list_info li",
        ...
        },
        {
            ...
            tags_options: [
                [
                    EnumOption.DISPLAY,
                    { val: "flex", edit_option: EnumEditOption.NONEDITABLE },
                ],
                [
                    EnumOption.FLEX_DIRECTION,
                    { val: "column", edit_option: EnumEditOption.NONEDITABLE },
                ],
                [
                    EnumOption.WIDTH,
                    {
            ...
            li_array: [
                {
                    href: ["qq"],
                    images: [
                        "/resource/img/constructor_default/214/Instagram_black.svg",
                    ],
                },
                {
                    href: ["www"],
                    images: [
                        "/resource/img/constructor_default/214/Telegram_black.svg",
                    ],
                },
                {
                    href: ["ee"],
                    images: [
                        "/resource/img/constructor_default/214/WhatsApp_black.svg",
                    ],
                },
                {
                    href: ["fff"],
                    images: [
                        "/resource/img/constructor_default/214/YouTube_black.svg",
                    ],
                },
            ],
            tags_options: [
        ...
        },
        {
            ...
            tags_options_tablet: [],
            tags_options_mobile: [[EnumOption.WIDTH, { val: 50 }]],
        },
        {
        ...
        },
        {
            ...
            title: "Фон - стили",
            tags_options: [[EnumOption.WIDTH_MAX, { val: 40 }]],
            tags_options_tablet: [[EnumOption.WIDTH_MAX, { val: 40 }]],
            tags_options_mobile: [[EnumOption.WIDTH_MAX, { val: 40 }]],
        },
        {
            class: ".btn",
            title: "Кнопка записаться",
            text: "Записаться в офис",
            tags_options: [
                ...
                [
                    EnumOption.CURSOR,
                    { val: "pointer", edit_option: EnumEditOption.NONEDITABLE },
                ],
            ...
            <div class="section">
                <div class="container">
                    <div class="column-1">
                        ...
                        <div> <a class="btn" contenteditable></a></div>
                        <div class="soc">
