        ...
        <div is="admin-user-pay-plan" class="admin-user-pay-plan">
            ...
            <div class="group-list slide-down-animation">
                    ...
                    >
                        ...
                        >
                            <div class="flexbe-white-box shadow">
                                ...
                                <a
                                    v-if="!pageData.data_tariff.tariff_id"
                                    :href="'/pay/payment/tariff/' + plan_id"
                                    class="plan-select flexbe-button block filled is-primary weight-medium"
                                >
                                ...
                                >
                                    <span class="flexbe-text">Активна</span>
                                </a>
                                <a
                                    v-else
                ...
                <div v-if="archiveTarifSystem" class="group-content">
                    <div
                        is="admin-user-pay-plan-archive"
                        class="admin-user-pay-plan-archive"
                    >
