...
class ClonePage extends BasicController
{
    ...
    private function view(
        ...
        addJS(MAIN_URL . '/sites/resource/js/setting/page/clone_page.js');
        // -----------------------------------------------------------
        $title = 'Создать копию | ' . $data_page['title'] . ' | ' . $data_site['title'];

        include VERSION . '/head.php';
        require MAIN_DIR . '/sites/view/settings/page/clone_page.php';
